...
- 活跃 spec 在 `.kiro/specs/` 根目录；`backend-contract-v1` 与 `frontend-refoundation-v1` 已完成，当前主线进入 `backend-core-refactor-v1`（7/10 已完成；Task 7 已完成 session runtime transport/recovery 内聚拆分）
