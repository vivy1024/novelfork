...
const allowedPatchTargets = new Set([
	...
	"frontend/components/narrator/vlist/segment-adapter.test.ts",
	"frontend/components/narrator/vlist/useVListLabels.ts",
	"frontend/components/narrator/workspace/DockviewWorkspace.tsx",
	...
	"server/services/__tests__/edit-regen-revert.test.ts",
	...
	"shared/pretext-layout/reasoning-segments.ts",
	"shared/pretext-layout/segment-adapter.ts",
	"tests/preload.ts",
	"tests/server/integration/plugins/cline-external-commands.e2e.test.ts",
	...
	"tests/server/lib/proxy-env.test.ts",
