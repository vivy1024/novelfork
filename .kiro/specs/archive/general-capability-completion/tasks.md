...
- [x] 4.5 启动时自动检查（如果 `autoCheckUpdate` 开启）
...
- [x] 6.1 新增 `docs/learning/13-runtime-capabilities.md` — CLAUDE.md 读取、压缩摘要、Staleness check、文件 dedup
- [x] 6.2 新增 `docs/learning/14-subagent-system.md` — 子代理类型、后台任务、Fork 模式、Await
- [x] 6.3 新增 `docs/learning/15-tool-search-and-skills.md` — ToolSearch、Skill 加载、工具过滤
- [x] 6.4 新增 `docs/learning/16-security-and-sandbox.md` — 沙箱模式、进程管理、目录白名单
- [x] 6.5 新增 `docs/learning/17-browser-and-terminal.md` — Browser 截图、Terminal 工具
- [x] 6.6 新增 `docs/learning/18-web-tools.md` — WebSearch、WebFetch
- [x] 6.7 更新 `docs/learning/README.md` 索引
- [x] 6.8 更新 `docs/learning/04-narrator-conversation.md` — 新增工具（PlanMode/TaskCreate/AskUser/Recall/Send）
- [x] 6.9 更新 `docs/learning/06-settings-and-routines.md` — 服务器配置、使用历史真实数据
