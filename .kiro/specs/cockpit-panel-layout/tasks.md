...
- [ ] A1. ExpandablePanel PanelType 扩展为 7 个（quality/health/progress/arcs/drift/compliance/alert）
- [ ] A2. PanelContent switch 加 CharacterArcsPanel / StyleDriftPanel / CompliancePanel 渲染
- [ ] A3. StatusBar 加 7 个面板切换 icon button（替代当前仅 quality+alert 的 2 个）
- [ ] A4. BeatProgressBar 嵌入 StatCard 网格（进度条形态）
- [ ] A5. DefaultCockpitView 重写上半区为 StatCard 2×3 网格（fetch overview-stats）
