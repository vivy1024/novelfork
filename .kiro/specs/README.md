...
| `v0-1-0-release-readiness` | 20 | ⏳ 执行中（10/20；已完成发布准备基线、会话页 Task 2-4、叙述者中心/Shell 左栏 Task 5-6、产品壳首页 Task 7-8、作品工作台 Task 9-10；下一步 Task 11 设置/Provider 可读性与 E2E 夹具污染治理） |
