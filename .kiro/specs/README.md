...
| `v0-1-0-release-readiness` | 20 | ⏳ 执行中（13/20；已完成发布准备基线、会话页 Task 2-4、叙述者中心/Shell 左栏 Task 5-6、产品壳首页 Task 7-8、作品工作台 Task 9-10、设置/Provider Task 11、Routines Task 12、clean/isolated root 主路径 E2E Task 13；下一步 Task 14 实际打开软件手工验活） |
