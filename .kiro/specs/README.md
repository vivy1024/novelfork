...
| Spec | 角色 | 当前进度 | 执行口径 |
|---|---|---:|---|
| `novel-creation-workbench-complete-flow` | 当前唯一主线 | 32 / 45 | 推进小说创作工作台完整闭环；继续执行未完成 tasks，不能恢复 mock/fake/noop 假成功。 |
...
1. 继续 Phase 4：BibleCategoryView 与 BibleEntryEditor、伏笔追踪、大纲、发布检查与导出。
