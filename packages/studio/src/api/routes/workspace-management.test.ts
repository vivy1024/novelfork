...
function makeConfig(workspace = DEFAULT_WORKSPACE) {
  return {
    profile: { name: "", email: "" },
    preferences: { theme: "auto" as const, fontSize: 14, fontFamily: "", autoSave: true, autoSaveDelay: 2000, dailyWordTarget: 6000, workbenchMode: false, advancedAnimations: true, language: "zh", oledBlack: false },
