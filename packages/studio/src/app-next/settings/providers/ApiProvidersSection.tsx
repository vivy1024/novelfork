  ...
  return (
    <section className="space-y-3">
      <div className="flex items-start justify-between gap-3">
        ...
        <Button variant="outline" size="sm" onClick={onOpenProtocolModal ?? onToggleAddForm}>
          + 添加供应商
        </Button>
      </div>

      {showProtocolModal && onCloseProtocolModal && onSelectProtocol && (
        <ProtocolSelectModal open={showProtocolModal} onClose={onCloseProtocolModal} onSelect={onSelectProtocol} />
      )}
