...
export const RUNTIME_COMMAND_REGISTRY: readonly RuntimeCommandDefinition[] = [
  ...
  },
  {
    ...
    description: "按小说写作主链路生成下一章结果：cockpit.snapshot → pgi.ask → scene.spec → pipeline.write。candidate/draft 主入口已移除。",
    scope: "novel",
    inputSchema: TEXT_ARGS,
    ...
    toolDependencies: ["cockpit.snapshot", "pgi.ask", "scene.spec", "pipeline.write"],
